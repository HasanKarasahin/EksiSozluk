...
<?php  $kontrol=0; $hangiprofilde=0;  $entrykontrol=0;
    $baslikkontrol=0;
            ...
            <?php 
                ...
                else
                {
                    if($_GET['profil']!=$_SESSION['nick'])
                    {
                        ...
                        {
                        ?>
                       <div class="badidurumdiv"><a href="badi.php?te=<?php echo $_SESSION['yazarid']?>&ted=<?php echo $ziyaretedilenuye['id']; ?>&takibicek">badidurumu(arkadaslık+)</a></div>
                       <?php
                        }
                        else
                        {
                             ?>
                       <div class="badidurumdiv"><a href="badi.php?te=<?php echo $_SESSION['yazarid']?>&ted=<?php echo $ziyaretedilenuye['id']; ?>&takip">badidurumu(arkadaslık)</a></div>
                       <?php
                        }
                    }
              ...
              <?php if(isset($_SESSION['oturum']))
                    {
                        ...
                        {
                        ?>
                        <a href="sil.php?ys=<?php echo $yorumlar['YorumId'];?>"><div id="sikayet">sil</div></a>
                        <a href="#"><div id="sikayet">düzenle</div></a>
                        <?php    
                        }
                    }
              ?>
                    ...
                    $ziyaretedilenuye=mysqli_fetch_assoc($ziyaretedilenuyesql); ?>
						<a href="index.php?profil="><div id="yazar"> <?php echo $ziyaretedilenuye['nick'];?>
						</div></a>
						<a href="#"><div id="tarih">
      ...
      <div class="Yorumdiv">
                    <form action="" method="post">
                        ...
                        <select name="katagori">
                          ...
                          <textarea  name="yenibaslik" rows="2" cols="84px" maxlength="535px" style=" text-align:left  ; font-size: 14px ;resize:none;" required></textarea>
                        
                          <textarea  name="yeniyorum" rows="6" cols="84px" maxlength="535px" style=" text-align:left  ; font-size: 24px ;resize:none;" required></textarea>
