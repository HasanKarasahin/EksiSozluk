<form action="" method="POST">
    <div id="kayitdiv">
        ...
        <p>hesap güvenliğiniz açısından şifrenizin <strong> diğer sitelerde kullandığınız şifrelerden farklı
                olmasını</strong> tavsiye ederiz.</p>
        <p>şifre</p>
        ...
        <input type="checkbox" name="sartlar" value="onaylandi"><a href="sartlar.php" onclick="this.target='_blank'">ekşi
            sözlük kullanıcı sözleşmesi</a>ni okudum ve kabul ediyorum<br><br/>
