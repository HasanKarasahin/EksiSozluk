<html>
<head>
	<title>kullanici bilgileri - eksisozluk </title>
...
<body>
<h1>ekşi sözlük kullanıcı sözleşmesi</h1>
    <div id="yazi">
	ekşi sözlük, kayıtlı kullanıcılarının içeriklerine yer sağlayıcılık hizmeti veren bir internet sitesi olup, ekşi teknoloji ve bilişim anonim şirketi’ne (ekşi teknoloji) aittir.
	ekşi sözlük, kayıtlı kullanıcılarının içeriklerine yer sağlayıcılık hizmeti veren bir internet sitesi olup, ekşi teknoloji ve bilişim anonim şirketi’ne (ekşi teknoloji) aittir.

ekşi sözlük(site) kayıtlı kullanıcısı olduğunuzda tabi olduğunuz kurallar ve diğer yasal konular aşağıdaki gibidir. 
...
ekşi sözlük’te kayıtlı kullanıcı olmak için sizden istenilen bilgileri girmeniz gerekmekte. bu işlem tamamlandıktan sonra size aktivasyon için eposta göndereceğiz.

hesabınız aktive olduktan sonra oluşturacağınız içerikler (entryler) yazarlığınız onaylanana kadar sitede görünmeyecektir ancak bu içeriklere farklı kanallardan erişim sağlayabiliriz.

yazarlığınızın onaylanması ekşi sözlük’ün takdirinde olup, kayıtlı kullanıcı olmanız yazar olabileceğiniz anlamına gelmemektedir. kayıtlı kullanıcıların yazarlığa alınmasındaki değerlendirme kriterleri, tercih edilecek yöntemler veya süreye ilişkin de hiçbir taahhütte bulunmamaktayız. yazar alımları sürekli yapılmakla beraber, belli dönemlerde belli kriterleri karşılayanların yazarlığa alınması gibi ek uygulamalarımız da olabilmektedir.

- işleyiş ve sorumluluklarınız

oluşturduğunuz içerik ekşi sözlük kurallarına ve hukuka uygun olmak zorundadır. oluşturduğunuz içerik tüm sorumluluğu size ait olmak üzere ve hiçbir ön denetime tabi olmadan yayına girdiğinden, oluşturduğunuz içeriğin hukuka aykırı olmadığından lütfen emin olun. içerik yayına alındığı anda hukuki sorumluluğunuz başladığından, oluşturduğunuz içeriğin daha sonra tarafınızca veya şikayet/haberdar edilme vs. üzerine ekşi sözlük tarafından silinmiş olması sorumluluğunuzu ortadan kaldırmayacaktır. 

ekşi sözlük kuralları, entrylerin silinme sebepleri ve diğer yaptırımlar kullanıcılara site üzerinden duyurulmaktadır, bunların takibi sizin sorumluluğunuzdadır. 

entryleriniz ekşi sözlük kurallarına uygun olmaması nedeniyle veya hukuka aykırı olması sebebiyle yayından kaldırılabilir. kurallara veya hukuka aykırılıklar nedeniyle yazarlığınız geçici olarak durdurulabilir veya kullanıcı hesabınız kapatılabilir. diğer tüm haklarımız saklıdır.
...
kendi isteğiniz doğrultusunda mesajlaşma yoluyla paylaştığınız veya entrylerinizle alenileştirdiğiniz bilgilerinize ilişkin olarak ekşi sözlük’ün hiçbir sorumluluğu bulunmamaktadır. kişisel yazışma yoluyla veya yayınladığınız entrylerde paylaştığınız bilgilere özen göstermenizi tavsiye ederiz.
...
bu sözleşme en son 26.01.2016 tarihinde güncellenmiştir.
	</div>
</body>
</html>