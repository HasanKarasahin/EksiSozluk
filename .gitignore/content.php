  <div id="content">
        <div id="content_left">
			<div id="katagoriadi">	
				...
				$menugetir=mysqli_query($baglan,"SELECT * FROM ustmenu");
		...
		else
		{
			...
			<?php
				...
				if(isset($_GET["b"]) )
				{
                    ...
                    ?>
                        ...
                        <?php $sayfalar= ceil($yorumsayisi[0]/10);?>
                            ...
                            <a href="index.php?b=<?php echo $_GET['b']?>&sayfa=<?php if($sayfalar>=$sayfasayisi+1) {echo $sayfasayisi+1;}else{ echo $sayfalar; }?>">
                                <input class="sayfalamab" type="submit" value=">>"/>        
                             </a>
					...
					<div id="entryfooter">
                        ...
                        $likesql=mysqli_query($baglan,"SELECT * FROM yorumbegeni WHERE YazarId='{$_SESSION['yazarid']}' AND YorumId='{$basliginyorumlari['YorumId']}' AND BaslikId='{$basliginyorumlari['BaslikId']}'");
                         while($like=mysqli_fetch_row($likesql)>0)
                            {  
                                ?>
                            <a href="likedislike.php?yid=<?php echo $basliginyorumlari['YorumId'];?>&bid=<?php echo $basliginyorumlari['BaslikId'];?>&like"><div id="likeaktif"></div></a>
                                <?php
                              $likekontrol=1;
                            }
                         if( $likekontrol==0)
                          {
                        ?>
                            <a href="likedislike.php?yid=<?php echo $basliginyorumlari['YorumId'];?>&bid=<?php echo $basliginyorumlari['BaslikId'];?>&like"><div id="likepasif"></div></a>
                        <?php
                           } 
                            ...
                            $dislikesql=mysqli_query($baglan,"SELECT * FROM yorumdislike WHERE YazarId='{$_SESSION['yazarid']}' AND YorumId='{$basliginyorumlari['YorumId']}' AND BaslikId='{$basliginyorumlari['BaslikId']}'");
                             ...
                             {  
                              ?>
                               <a href="likedislike.php?yid=<?php echo $basliginyorumlari['YorumId'];?>&bid=<?php echo $basliginyorumlari['BaslikId'];?>&dislike"><div id="dislikeaktif"></div></a>
                              <?php
                              $dislikekontrol=1;
                              }
                             if( $dislikekontrol==0)
                             {
                              ?>
                            <a href="likedislike.php?yid=<?php echo $basliginyorumlari['YorumId'];?>&bid=<?php echo $basliginyorumlari['BaslikId'];?>&dislike"><div id="dislikepasif"></div></a>
                             <?php
                            }
                         }
                        else
                        {
                            ?>
                        <a href="#"><div id="likepasif"></div></a>
						<a href="#"><div id="dislikepasif"></div></a>
                            <?php
                        }
                         if(@$_SESSION['rutbe']=="admin")
                         {
                             ?>
                                 <a href="sil.php?ys=<?php echo $basliginyorumlari['YorumId']; ?>"><div id="sikayet">sil</div></a>
                             <?php
                         }
                         else
                         {
                             ?>
                                <a href="#"><div id="sikayet">***</div></a>
                             <?php
                         }
                        ?>
                        ...
                        ?>
						<a href="index.php?profil=<?php echo $uye['nick'] ?>"><div id="yazar">
							<?php
									echo $uye['nick'];
								?>
						</div></a>
				...
				while($baslik=mysqli_fetch_assoc($basliklarigetirsql))
				{
						...
						<li>
					<a href="index.php?b=<?php echo $baslik_dizisi[$rastgele_indis_baslik]?>&sayfa=1" id="baslik">
						<?php 
                            echo $indisegorebaslik['BaslikAdi']; 
                            if($kontrol==1)
                            {
                                ?><a href="sil.php?bs=<?php echo $baslik_dizisi[$rastgele_indis_baslik]; ?>">basliksil</a><?php
                            }   
                        ?>
					</a>
					...
					<div id="entryfooter">
                        ...
                        <?php 
                         ...
                         {
                             ?>
                                 <a href="sil.php?ys=<?php echo $yorum['YorumId'];  ?>"><div id="sikayet">sil</div></a>
                             <?php
                         }
                         else
                         {
