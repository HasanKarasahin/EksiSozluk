<?php session_start(); ob_start();   include_once("ayarlar.php");?>
<html>
<head>
	<title>ekşi sözlük - kutsal bilgi kaynagi </title>
    <meta charset="utf-8" data-is-mobile="true" id="eksi">
    <link rel="stylesheet" type="text/css" href="css/style.css">
	<link rel="shortcut icon" href="./images/yesildamla.png"/><link rel="stylesheet" type="text/css" href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:400,700,400italic,700italic,600&subset=latin,latin-ext">
        ...
        <div id="header_content">
			...
			?>
				...
				<?php 	
					...
					{
						?>
						<a href="index.php?<?php echo 'm='.$goster['menu'] ?>" class="menulink"><input type="submit" class="linkbutonlari" name="m" value="<?php echo $goster["menu"] ?>"/></a>
						<?php
					}
					...
					//header("Refresh: 10; url=http://sanalkurs.net");
