                    ...
                    <form action="" method="POST"><?php
                        while ($kisilerim = mysqli_fetch_assoc($kisilerimsql)) {
                            ...
                            if ($kisi = mysqli_fetch_row($sql) > 0) {
                                ?>
                                <li>
                                    <input id="okunmamis" type="submit" name="okunmamiskisi"
                                           value='<?php echo $kisilerim['nick']; ?>'/>
                                </li>
                                <?php
                            } else {
                                ?>
                                <li>
                                    <input id="okunmus" type="submit" name="okunmuskisi"
                                           value='<?php echo $kisilerim['nick']; ?>'/>
                                </li>
                                <?php
                            }
                        ...
                        while ($digerkisiler = mysqli_fetch_assoc($digerkisilersql)) {
                            ...
                            if ($kisi = mysqli_fetch_row($okunmamissql) > 0) {
                                ...
                                <li>
                                    <input id="okunmamis" type="submit" name="okunmamiskisi"
                                           value='<?php echo $digerkisiler['nick']; ?>'/>
                                </li>
                                <?php
